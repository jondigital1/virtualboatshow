    ...
    <>
      ...
      <section style={{ background: "#F4F1EA", padding: "clamp(30px,4vw,52px) clamp(18px,5vw,56px) clamp(56px,7vw,90px)" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(min(100%,340px),1fr))", gap: "clamp(28px,4vw,52px)", alignItems: "center" }}>
          <div style={{ minWidth: 0 }}>
            ...
            <h1 style={{ fontFamily: DISPLAY, fontWeight: 800, fontSize: "clamp(34px,5vw,68px)", lineHeight: 0.98, letterSpacing: "-.03em", margin: "16px 0 0" }}>The {LOCAL.town} boat show, <span style={{ color: "var(--accent)" }}>without leaving the dock.</span></h1>
            <p style={{ maxWidth: 560, fontSize: "clamp(16px,1.3vw,19px)", lineHeight: 1.6, color: "#43596a", margin: "22px 0 0" }}>{DEALER.shortName} brings the Virtual Boat Show home to {LOCAL.town} and {LOCAL.region}. Browse the whole fleet, lock in show pricing, and value your trade, all from the same water you already boat on.</p>
      ...
      <section style={{ background: "#0A2138", color: "#fff", padding: "clamp(66px,8vw,110px) clamp(18px,5vw,56px)", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 760, margin: "0 auto" }}>
          <div style={{ fontFamily: MONO, fontSize: 12, letterSpacing: ".2em", textTransform: "uppercase", color: "var(--accent)" }}>{LOCAL.town}, your show is ready</div>
          <h2 style={{ fontFamily: DISPLAY, fontWeight: 800, fontSize: "clamp(32px,5vw,60px)", lineHeight: 1, letterSpacing: "-.03em", margin: "16px 0 0" }}>Start the boat show from your couch.</h2>
          <p style={{ fontSize: "clamp(16px,1.3vw,19px)", lineHeight: 1.55, color: "rgba(255,255,255,.78)", margin: "20px auto 0", maxWidth: "52ch" }}>Browse {DEALER.shortName}&rsquo;s full fleet, lock in show pricing, and set your appointment. When you&rsquo;re ready, they&rsquo;re right here on {DEALER.waterBody}.</p>
